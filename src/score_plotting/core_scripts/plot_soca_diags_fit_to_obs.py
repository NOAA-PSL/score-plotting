...
def config():
    ...
    config_dict = {
        ...
        'experiment_list': ['3dvar_coupledreanl_scoutrun_1979streamv1_test'
                         ],
    ...
    '''
    friendly_names_dict={"3dvar_coupledreanl_scoutrun_1979streamv1_test": "weakly coupled scout (3DVar)",
        ...
        for var in variable_list:
            if var == 'waterTemperature':
                data_frame_parts_dict[var] = global_data_frame[
                    global_data_frame['metric_type'] == 'water temperature']
            else:
                data_frame_parts_dict[var] = global_data_frame[
